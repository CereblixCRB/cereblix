...
(append `:3333` pool / `:3334` solo). Offline speed test: `unm -bench 10`. **Open source (MIT)** — browse the [`unm/`](unm/) source or build it yourself from [`unm-src.tar.gz`](https://github.com/CereblixCRB/cereblix/releases/latest/download/unm-src.tar.gz). Mine to
